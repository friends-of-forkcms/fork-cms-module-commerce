...
echo "👉 Modifying Fork CMS parameters.yml..."
...
echo "👉 Installing necessary Fork CMS modules..."
...
echo "👉 Applying custom SQL queries to our DB..."
