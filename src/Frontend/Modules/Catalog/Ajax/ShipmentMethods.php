...
use Backend\Modules\Catalog\ShipmentMethods\Base\Checkout\Quote;
...
class ShipmentMethods extends FrontendBaseAJAXAction
{
    ...
    public function execute(): void
    {
        ...
        $html = $this->template->getContent('Catalog/Layout/Templates/Checkout/ShipmentMethods.html.twig');
