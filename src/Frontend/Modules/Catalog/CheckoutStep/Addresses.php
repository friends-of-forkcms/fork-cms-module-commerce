...
use Backend\Modules\Catalog\Domain\OrderAddress\Event\Created;
use Backend\Modules\Catalog\Domain\OrderAddress\Event\Updated;
...
use Backend\Modules\Catalog\Domain\OrderAddress\OrderAddressType;
use Common\Uri;
...
class Addresses extends Step
{
    ...
    public function render()
    {
        if ($this->getRequest()->query->has('add') || $this->getRequest()->query->has('edit')) {
            ...
            return $this->template->getContent('Catalog/Layout/Templates/Checkout/Step/AddressForm.html.twig');
        } else {
    ...
    {
        return $this->get('catalog.repository.order_address');
    }
}
