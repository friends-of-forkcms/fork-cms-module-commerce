...
use Backend\Modules\Catalog\Domain\Account\Account as CatalogAccount;
...
abstract class Step
{
    ...
    public function render()
    {
        ...
        $html = $this->template->getContent('Catalog/Layout/Templates/Checkout/Step/' . $name . '.html.twig');
    ...
    {
        return Navigation::getUrlForBlock('Catalog', 'Cart') . '/' . Language::lbl('Checkout');
    }
    ...
    protected function getAccount(): ?CatalogAccount
    {
