$(function () {
  ...
  $(document).on("commerce.products.filtered", function () {
    runEnhancedEcommerce();
  });
  ...
  $(document).on("commerce.product.add_to_cart", function (e) {
    ga("ec:addProduct", {
      id: e.product.sku,
  ...
  // Handle product added to cart
  $(document).on("commerce.product.remove_from_cart", function (e) {
    ga("ec:addProduct", {
      id: e.product.sku,
      name: e.product.title,
      category: e.product.category,
