...
use Backend\Modules\Commerce\Domain\ProductDimension\ProductDimensionType;
use Backend\Modules\Commerce\Domain\ProductDimensionNotification\ProductDimensionNotificationType;
use Backend\Modules\Commerce\Domain\ProductSpecial\ProductSpecialType;
use Backend\Modules\Commerce\Domain\SpecificationValue\ProductSpecificationValueDataTransferObject;
use Backend\Modules\Commerce\Domain\SpecificationValue\ProductSpecificationValueType;
            ...
            ->addEventListener(FormEvents::PRE_SET_DATA, function (FormEvent $event) {
                $event->getForm()->add(
                    ...
                    [
                        ...
                        'generate_url_callback_class' => 'commerce.repository.product',
