...
class BuckarooType extends Type
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add(
            ...
            [
                'required' => true,
                'label' => 'lbl.ApiEnvironment',
                'choices' => [
                    'lbl.Test' => BuckarooDataTransferObject::ENVIRONMENT_TEST,
                    'lbl.Production' => BuckarooDataTransferObject::ENVIRONMENT_PRODUCTION,
                ],
            ]
        )->add(
            'websiteKey',
