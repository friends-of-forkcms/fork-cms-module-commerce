...
class Model
{
    ...
    {
        $item['edited_on'] = BackendModel::getUTCDate();
        BackendModel::getContainer()->get('database')->update('commerce_categories', $item, 'id = ?', array($item['id']));
    ...
    {
        BackendModel::invalidateFrontendCache('productsCache');
        return (int)BackendModel::getContainer()->get('database')->update('commerce_images', $item, 'id = ?', array($item['id']));
    }
    ...
    {
        BackendModel::invalidateFrontendCache('productsCache');
        return (int)BackendModel::getContainer()->get('database')->update('commerce_files', $item, 'id = ?', array($item['id']));
    }
    ...
    {
        BackendModel::invalidateFrontendCache('productsCache');
        return (int)BackendModel::getContainer()->get('database')->update('commerce_videos', $item, 'id = ?', array($item['id']));
    }
}
