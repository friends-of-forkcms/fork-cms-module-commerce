...
class Cart
{
     ...
     * @var CartRule[]
     *
     * @ORM\ManyToMany(targetEntity="Backend\Modules\Catalog\Domain\CartRule\CartRule")
     * @ORM\JoinTable(name="catalog_cart_cart_rules",
     ...
     * @var Order
     *
     * @ORM\OneToOne(targetEntity="Backend\Modules\Catalog\Domain\Order\Order", mappedBy="cart")
     */
    private $order;
    ...
    private function addVat($vat, ?float $price, $subtractVat = false)
    {
        if (is_int($vat)) {
            ...
            $vatRepository = Model::get('catalog.repository.vat');
