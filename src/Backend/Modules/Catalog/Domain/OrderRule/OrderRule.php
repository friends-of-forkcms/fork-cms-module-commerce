...
/**
 * @ORM\Table(name="catalog_order_rules")
...
class OrderRule
{
     ...
     * @var Order
     *
     * @ORM\ManyToOne(targetEntity="Backend\Modules\Catalog\Domain\Order\Order", inversedBy="rules")
     ...
     * @var CartRule
     *
     * @ORM\ManyToOne(targetEntity="Backend\Modules\Catalog\Domain\CartRule\CartRule")
