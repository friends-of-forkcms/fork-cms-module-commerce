...
/**
 * @ORM\Table(name="catalog_order_product_options")
...
class OrderProductOption
{
     ...
     * @var OrderProduct
     *
     * @ORM\ManyToOne(targetEntity="Backend\Modules\Catalog\Domain\OrderProduct\OrderProduct", inversedBy="product_options")
