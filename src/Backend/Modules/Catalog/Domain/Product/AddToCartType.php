...
use Backend\Modules\Catalog\Form\ChoiceTypeExtension;
use Backend\Modules\Catalog\Form\ColorType;
use Backend\Modules\Catalog\Form\EntityTypeExtension;
use Backend\Modules\Catalog\Form\BetweenType;
use Backend\Modules\Catalog\Form\TextTypeExtension;
                        ...
                        $builder->create(
                            ...
                            HiddenType::class
                                ...
                                function ($reverseTransform) use ($productOption) {
                                     ...
                                     */
                                    $productOptionValueRepository = Model::get('catalog.repository.product_option_value');
