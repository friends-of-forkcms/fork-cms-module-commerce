...
namespace Backend\Modules\Catalog\Domain\OrderProductNotification;

use Backend\Modules\Catalog\Domain\OrderProduct\OrderProduct;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Table(name="catalog_order_product_notifications")
...
class OrderProductNotification
{
     ...
     * @var OrderProduct
     *
     * @ORM\ManyToOne(targetEntity="Backend\Modules\Catalog\Domain\OrderProduct\OrderProduct", inversedBy="product_notifications")
