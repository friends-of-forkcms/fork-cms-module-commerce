...
class OrderAddress
{
     ...
     * @var Account
     *
     * @ORM\ManyToOne(targetEntity="Backend\Modules\Catalog\Domain\Account\Account", inversedBy="addresses")
     ...
     * @var Country
     *
     * @ORM\ManyToOne(targetEntity="Backend\Modules\Catalog\Domain\Country\Country", inversedBy="addresses")
