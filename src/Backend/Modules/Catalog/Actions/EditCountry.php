...
use Backend\Modules\Catalog\Domain\Country\CountryType;
use Backend\Modules\Catalog\Domain\Country\CountryRepository;
use Backend\Modules\Catalog\Domain\Country\Command\UpdateCountry;
use Backend\Modules\Catalog\Domain\Country\Event\Updated;
...
class EditCountry extends BackendBaseActionEdit
{
    ...
    private function getCountry(): Country
    {
        ...
        $countryRepository = $this->get('catalog.repository.country');
