...
use Backend\Modules\Catalog\Domain\ProductOptionValue\Event\DeletedProductOptionValue;
use Backend\Modules\Catalog\Domain\ProductOptionValue\ProductOptionValue;
use Backend\Modules\Catalog\Domain\ProductOptionValue\Command\DeleteProductOptionValue as DeleteCommand;
...
class DeleteProductOptionValue extends BackendBaseActionDelete
{
    ...
    {
        try {
            return $this->get('catalog.repository.product_option_value')->findOneById(
                $id
            );
