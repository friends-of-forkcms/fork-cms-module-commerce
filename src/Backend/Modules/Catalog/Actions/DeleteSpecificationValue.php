...
use Backend\Modules\Catalog\Domain\SpecificationValue\Event\DeletedSpecificationValue;
use Backend\Modules\Catalog\Domain\SpecificationValue\Command\DeleteSpecificationValue as DeleteCommand;
...
class DeleteSpecificationValue extends BackendBaseActionDelete
{
    ...
    {
        try {
            return $this->get('catalog.repository.specification_value')->findOneById(
                $id
            );
